 ...
 */
@protocol FlutterApplicationLifeCycleDelegateSDK
 ...
 */
@protocol FlutterPluginSDK <NSObject, FlutterApplicationLifeCycleDelegateSDK>
@required
/**
 ...
 * including headless `FlutterEngineSDK` instances.
 *
 * This method is typically called from within an application's `AppDelegate` at
 * startup to allow for plugins which create additional `FlutterEngineSDK` instances
...
@optional
/**
 * Called when a plugin is being removed from a `FlutterEngineSDK`, which is
 * usually the result of the `FlutterEngineSDK` being deallocated.  This method
 ...
 * the `FlutterEngineSDK` via `-[FlutterPluginRegistrySDK publish:]`.
 *
 ...
 */
- (void)addApplicationLifeCycleDelegate:(NSObject<FlutterApplicationLifeCycleDelegateSDK>*)delegate;
@end
