 ...
 *   otherwise.
 */
typedef void (^FlutterHeadlessDartRunnerSDKCallback)(BOOL success);

/**
 * The deprecated FlutterHeadlessDartRunnerSDK runs Flutter Dart code with a null rasterizer,
