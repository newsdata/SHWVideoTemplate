...
#import "RMPermissionHandlerPlugin.h"
...
FOUNDATION_EXPORT double permission_handler_rmVersionNumber;
FOUNDATION_EXPORT const unsigned char permission_handler_rmVersionString[];
